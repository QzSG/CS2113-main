...
public class GitHubStorage implements OnlineStorage{
    ...
    public void saveContentToStorage(String content, String fileName) throws IOException, OnlineBackupFailureException {
        throw new UnsupportedOperationException("This online storage does not support saveContentToStorage with 2 variables");
    }

    @Override
    public void saveContentToStorage(String content, String fileName, String description) throws IOException, OnlineBackupFailureException {
